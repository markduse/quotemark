...
const TERM_CARRIERS = [
  ...
  {id:'instabrain', name:'Instabrain', sub:'Term Life', abbr:'I', enabled:true, termOnly:true, supportedTerms:['10','15','20'],
   product:{B:'Term',C:null,D:null,E:null},
   fn:(age,male,smoker,tier,face,termLen)=>{
     if(tier!=='B') return null;
     const combo = male?(smoker?'mt':'mn'):(smoker?'ft':'fn');
  ...
  {id:'john_hancock', name:'John Hancock', sub:'Term Life', abbr:'JH', enabled:true, termOnly:true, supportedTerms:['10','15','20'],
   product:{B:'Term',C:null,D:null,E:null},
   fn:(age,male,smoker,tier,face,termLen)=>{
     if(tier!=='B') return null;
     const combo = male?(smoker?'mt':'mn'):(smoker?'ft':'fn');
  ...
  {id:'sbli', name:'SBLI', sub:'Term Life', abbr:'S', enabled:true, termOnly:true, supportedTerms:['10','15','20'],
   product:{B:'Term',C:null,D:null,E:null},
   fn:(age,male,smoker,tier,face,termLen)=>{
     if(tier!=='B') return null;
     const combo = male?(smoker?'mt':'mn'):(smoker?'ft':'fn');
