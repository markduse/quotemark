...
export const FEX_UW = {
  ...
  // ── Royal Neighbors — Ensured Legacy FE (OFFICIAL agent guide) ──
  ...
  rn: {
    ...
    home_o2_24hr:  'GI',
    mi_1yr:        {o:'D',  note:'Heart attack <2 yrs → Graded (GDB)'},
    mi_1to2:       'D',
    mi_2to3:       {o:'C',  note:'Heart attack >2 yrs → Standard (never Preferred)'},
    mi_3plus:      'C',
    stent_1yr:     {o:'D',  note:'Heart surgery <2 yrs → Graded'},
    stent_1to2:    'D',
    stent_2plus:   {o:'C',  note:'>2 yrs → Standard'},
    angina_1yr:    {o:'D',  note:'Angina (as CAD) <2 yrs → Graded'},
    angina_1to2:   'D',
    angina_2plus:  'C',
    cad:           {o:'C',  note:'CAD <2 yrs → Graded; >2 yrs → Standard'},
    chf:           {o:'GI', note:'CHF → GI only'},
    cardiomyo_new: {o:'D',  note:'Cardiomyopathy <2 yrs → Graded; >2 yrs → Standard'},
    cardiomyo_old: 'C',
    afib_ctrl:     'ok',
    pacemaker_new: {o:'D',  note:'Pacemaker <1 yr → Graded; >1 yr → Standard (defibrillator → GI only)'},
    pacemaker_old: 'C',
    aneurysm_new:  {o:'D',  note:'Aneurysm <1 yr → Graded; >1 yr → Standard'},
    aneurysm_old:  'C',
    stroke_1yr:    {o:'D',  note:'Stroke/TIA <1 yr → Graded; >1 yr → Standard'},
    stroke_1to2:   'C',
    stroke_2to3:   'C',
    stroke_3plus:  'C',
    cancer_lt2:    {o:'GI', note:'Cancer <2 yrs → GI only (multiple occurrences → GI only)'},
    cancer_2to3:   {o:'D',  note:'Cancer 2–5 yrs → Graded (GDB)'},
    cancer_3to4:   'D',
    cancer_4to5:   'D',
    cancer_5plus:  {o:'C',  note:'Cancer >5 yrs → Standard'},
    melanoma_lt2:  {o:'GI', note:'Follows cancer windows'},
    melanoma_2to4: 'D',
