...
export const FEX_UW = {
  ...
  moo: {
    ...
    basal_cell:    'ok',
    chemo_active:  'X',
    // ── Below rules from ITK live UW engine sweep 8/20/2026 ──
    angina_1yr:    'D',
    angina_1to2:   'D',
    angina_2plus:  {o:'C',  note:'Angina 2\u20134 yrs → Standard; 4+ → Preferred (ITK)'},
    kidney_disease:{o:'D',  note:'Kidney disease any stage → Modified (ITK)'},
    dialysis:      'X',
    alzheimers:    'X',
    lupus:         {o:'D',  note:'Systemic lupus → Modified (ITK)'},
    ms:            {o:'C',  note:'MS ever → Standard (ITK)'},
    parkinsons:    {o:'C',  note:'Parkinson\u2019s ever → Standard (ITK)'},
    hep_c_active:  {o:'C',  note:'Hep C chronic or cured → Standard (ITK)'},
    hep_c_curr:    'C',
    diabetes_comp: {o:'D',  note:'Diabetic nephropathy → Modified; neuropathy/retinopathy alone quote clean (ITK)'},
    alcohol_2yr:   {o:'X',  note:'Substance-abuse treatment within 2 yrs → not eligible (ITK)'},
    alcohol_2plus: {o:'C',  note:'Treatment 2+ yrs ago → Standard (ITK)'},
  },

  // ── UNITED HOME LIFE (Premier / Deluxe / EIWL) ─────────────────────
  // Source: ITK live UW engine sweep 8/20/2026 (docs/uw-extractions/
  // itk_uw_matrix_2026-08-20.json) — first real UHL rules in the engine.
  // UHL pattern: most conditions route to EIWL (graded) while treated
  // within the last 2 years, then quote CLEAN once 2+ yrs out. True
  // declines are rare: CHF <2yrs, events <1 yr, active cancer, dementia.
  uhl: {
    copd_no_o2:    {o:'D', note:'Treated within 2 yrs → EIWL graded; 2+ yrs since treatment → clean (ITK)'},
    copd_o2:       {o:'D', note:'ITK shows no oxygen knockout for UHL \u2014 active COPD treatment → EIWL. Verify with carrier'},
    home_o2_24hr:  {o:'D', note:'ITK shows no oxygen knockout for UHL \u2014 verify with carrier before writing'},
    bronchitis_chr:{o:'D', note:'Treated within 2 yrs → EIWL; 2+ yrs → clean (ITK pattern)'},
    chf:           {o:'X', note:'CHF treated within 2 yrs → decline; 2+ yrs since treatment → clean (ITK)'},
    mi_1yr:        {o:'X', note:'Heart attack <1 yr → decline (ITK)'},
    mi_1to2:       {o:'D', note:'Heart attack 1\u20132 yrs → EIWL graded (ITK)'},
    mi_2to3:       'ok',
    mi_3plus:      'ok',
    stent_1yr:     {o:'X', note:'Stent/angioplasty <1 yr → decline (ITK)'},
    stent_1to2:    {o:'D', note:'1\u20132 yrs → EIWL graded (ITK)'},
    stent_2plus:   'ok',
    angina_1yr:    {o:'D', note:'Angina treated within 2 yrs → EIWL (ITK)'},
    angina_1to2:   'D',
    angina_2plus:  'ok',
    afib_ctrl:     {o:'D', note:'AFib treated within 2 yrs → EIWL graded (ITK) \u2014 stricter than most carriers'},
    stroke_1yr:    {o:'X', note:'Stroke <1 yr → decline (ITK)'},
    stroke_1to2:   {o:'D', note:'Stroke 1\u20132 yrs → EIWL graded (ITK)'},
    stroke_2to3:   'ok',
    stroke_3plus:  'ok',
    cancer_lt2:    {o:'D', note:'Active cancer → decline; past cancer 1\u20132 yrs → EIWL graded (ITK)'},
    cancer_2to3:   'ok',
    cancer_3to4:   'ok',
    cancer_4to5:   'ok',
    cancer_5plus:  'ok',
    melanoma_lt2:  {o:'D', note:'Current → decline; past 1\u20132 yrs → EIWL (ITK)'},
    melanoma_2to4: 'ok',
    basal_cell:    'ok',
    chemo_active:  'X',
    alzheimers:    'X',
    dialysis:      {o:'D', note:'Dialysis → EIWL graded (ITK) \u2014 one of very few carriers that will take it'},
    kidney_disease:{o:'D', note:'Treated within 2 yrs (any stage) → EIWL; 2+ yrs → clean (ITK)'},
    diabetes_comp: {o:'D', note:'Diabetic neuropathy/nephropathy/retinopathy treated within 2 yrs → EIWL (ITK)'},
    neuropathy:    {o:'D', note:'Treated within 2 yrs → EIWL; 2+ yrs → clean (ITK)'},
    hep_c_active:  {o:'D', note:'Hep C (incl. cured <2 yrs ago) → EIWL (ITK)'},
    hep_c_curr:    'D',
    cirrhosis:     {o:'D', note:'Any stage incl. C/D → EIWL graded (ITK) \u2014 most carriers decline cirrhosis'},
    ms:            {o:'D', note:'Treated within 2 yrs → EIWL; stable 2+ yrs → clean (ITK)'},
    parkinsons:    {o:'D', note:'Treated within 2 yrs → EIWL; 2+ yrs → clean (ITK)'},
    als:           {o:'D', note:'Within 2 yrs → EIWL (ITK) \u2014 most carriers decline ALS outright'},
    lupus:         {o:'C', note:'Systemic lupus → Deluxe (ITK)'},
    schizophrenia: {o:'C', note:'Treated within 2 yrs → Deluxe (ITK)'},
    seizures_rare: {o:'D', note:'Seizures treated within 2 yrs → EIWL; 2+ yrs → clean (ITK)'},
    seizures_freq: 'D',
    felony:        {o:'D', note:'Felony within 7 yrs → EIWL (ITK)'},
  },
  ...
  newbridge: {
    ...
    mi_3plus:      'C',
    stent_1yr:     {o:'X',  note:'Stent/angioplasty <1 yr → not eligible (ITK)'},
    stent_1to2:    {o:'C',  note:'Stent/angioplasty 1\u20135 yrs → Standard (ITK live engine)'},
    stent_2plus:   'C',
    chf:           {o:'X',  note:'CHF ever → decline'},
    cardiomyo_new: 'X',
    cardiomyo_old: 'X',
    pacemaker_new: {o:'C',  note:'Pacemaker 1\u20135 yrs → Standard (ITK); <1 yr unverified. Defibrillator ever = decline'},
    pacemaker_old: 'C',
    stroke_1yr:    'D',
    stroke_1to2:   'D',
    stroke_2to3:   'C',
    stroke_3plus:  'C',
    cancer_lt2:    {o:'D',  note:'Active or <1 yr → not eligible; 1\u20132 yrs → Modified (ITK + guide)'},
    cancer_2to3:   {o:'C',  note:'Clean >2 yrs → Standard (melanoma treated as full cancer)'},
    cancer_3to4:   'C',
    cancer_4to5:   'C',
    cancer_5plus:  'C',
    melanoma_lt2:  {o:'D',  note:'<1 yr → not eligible; 1\u20135 yrs → Modified (ITK)'},
    melanoma_2to4: {o:'D',  note:'Melanoma stays Modified until 5 yrs out; 5+ → Standard (ITK)'},
    basal_cell:    'ok',
    chemo_active:  'X',
    // ── Below rules from ITK live UW engine sweep 8/20/2026 ──
    angina_1yr:    'D',
